  ...
  (function($, window) {
    ...
    Tendina = (function() {
      ...
      Tendina.prototype._openSubmenu = function(el) {
        ...
        $openMenus = this.$el.find('> .c-menu-item-active ul').not($targetMenu).not($targetMenu.parents('ul'));
        $(el).parent('li').addClass('c-menu-item-active');
        this._close($openMenus);
        this.$el.find('.c-menu-item-active').not($targetMenu.parents('li')).removeClass('c-menu-item-active');
      ...
      Tendina.prototype._closeSubmenu = function(el) {
        ...
        $targetMenu = $(el).next('ul');
        $nestedMenus = $targetMenu.find('li.c-menu-item-active');
        $(el).parent().removeClass('c-menu-item-active');
        this._close($targetMenu);
        $nestedMenus.removeClass('c-menu-item-active');
      ...
      Tendina.prototype._isCurrentlyOpen = function(el) {
        return $(el).parent().hasClass('c-menu-item-active');
      };
      ...
      Tendina.prototype._showSubmenus = function() {
        ...
        return this.$el.find('li').addClass('c-menu-item-active');
      };
      ...
      Tendina.prototype._openActiveMenu = function(element) {
        ...
        $activeMenu.parent().addClass('c-menu-item-active');
        return $activeParents.parent().addClass('c-menu-item-active');
      };
      ...
      Tendina.prototype.destroy = function() {
        ...
        return this.$el.find('.c-menu-item-active').removeClass('c-menu-item-active');
      };
