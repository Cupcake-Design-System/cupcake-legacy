describe('BD Blockquote', () => {
    ...
    it('should have correct styles', () => {   
        ...
        expect($quote.css('color'), 'color').to.equal(toRgb('#414152'));
        expect($quote.css('border-left'), 'border-left').to.equal('3px solid ' + toRgb('#0079bd'));
        ...
        expect($quote.find('cite').css('font-weight'), 'font-weight').to.equal('600');
        expect($quote.find('cite').css('line-height'), 'line-height').to.equal('15px');
        expect($quote.find('cite').css('color'), 'color').to.equal(toRgb('#414152'));
