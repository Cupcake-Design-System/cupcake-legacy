### Release 1.1.9
* Fixes #154 button focus state (#173) (c6a53be)
* Merge pull request #174 from Daria-Butova/master (0c86b87)
* Merge pull request #176 from Ipreo/issue160 (82a7c5b)
* #160 add meta info to dist files (254c1bb)
* Merge pull request #175 from oleksii-yenik/master (c615329)
* deleted yarn.lock (c3efeba)
* added yarn.lock to gitignore (2495487)
* deleted wrong fonts from src, added right fonts via npm package (a8ac019)
* Merge remote-tracking branch 'upstream/master' (c4b4d35)
* fix lint (d87af14)
* add single skeleton bar (d6e5a1f)
* tooltip hotfix (54e2427)
* tabs - bd adjustments (e6146c0)
* Merge branch 'master' of https://code.ipreo.com/Ipreo/cupcake (1830720)
* fix for #131 width:auto for inline input. (f39fc05)
* Gulp/build updates (#172) (51b32f9)
* add global boolean for white-label (#168) (019efaa)
* tooltip syntax fix to match other "data-" attributes (4bb2b30)
* adds button disabled states (#166) (b09b9a0)
* overide pills in a cupcake-suggester (#165) (c4c915c)
* set fixed heights for inputs (#164) (7bdf8a6)
* updated styles and added css popovers (#167) (34e90b7)
* overide pills in a cupcake-suggester (0ef5d54)
* Update CHANGELOG.md (8f11998)
